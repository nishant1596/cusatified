...
if(isset($_POST['search'])){
    ...
    $query="select * from civil_branch where semester='$semester' && subject='$subject'";          ///////////////////////////////////////////////////////
    $query2="select first_name,last_name from student,it_branch where it_branch.email=student.email";   ////////////////////////////
    $result=mysqli_query($conn,$query);
    $result2=mysqli_query($conn,$query2);
    $path='localhost/cusatified/upload_civil/';    ///////////////////////////////////////////////////////////
} ?>
...
<nav>
    <div class="nav-wrapper">
      <div class="col s12">
        <a href="civil_branch.html" class="breadcrumb">CIVIL Engineering</a>       <!--------------------------------------------------  -->     
      </div>
    </div>
</nav>

</div></div>
<form action="civil_branch.php" method="POST">     <!--------------------------------------------------  -->   
<div class="row">
...
Want to upload Notes ?? <a href="upload_civil.php">Click here to upload</a> <!--------------------------------------------------  -->   
...
if(mysqli_num_rows($result)>0){
    ...
    <tr>
                    ...
                    <td><a href="download_civil.php?notes_id=<?php echo $row['notes_id']; ?>"><button type="button">Download</button></a></td>
