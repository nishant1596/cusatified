...
include 'navbar.php';
$upload_dir = 'upload_me/';   /////////////////////////////////////////////////////////////////// 
?>
<?php 
if(isset($_POST['search'])){
    $semester=$_POST['semester'];
    $subject=$_POST['subject'];
    $query="select * from me_branch where semester='$semester' && subject='$subject'";          ///////////////////////////////////////////////////////
    $query2="select first_name,last_name from student,me_branch where me_branch.email=student.email";   ////////////////////////////
    $result=mysqli_query($conn,$query);
    $result2=mysqli_query($conn,$query2);
    $path='localhost/cusatified/upload_me/';    ///////////////////////////////////////////////////
} ?>
...
<nav>
    <div class="nav-wrapper">
      <div class="col s12">
        <a href="Homepage.html" class="breadcrumb">Mechanical Engineering</a>       <!--------------------------------------------------  -->     
      </div>
    </div>
</nav>

</div></div>
<form action="me_branch.php" method="POST">     <!--------------------------------------------------  -->   
<div class="row">
...
Want to upload Notes ?? <a href="upload_me.php">Click here to upload</a> <!--------------------------------------------------  -->   
...
if(mysqli_num_rows($result)>0){
    ...
    <tr>
                    ...
                    <td><a href="download_me.php?notes_id=<?php echo $row['notes_id']; ?>"><button type="button">Download</button></a></td><!-------------------------------------------------- -->
