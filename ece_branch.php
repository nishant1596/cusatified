...
include 'navbar.php';
$upload_dir = 'upload_ece/';   /////////////////////////////////////////////////////////////////// 
?>
<?php 
if(isset($_POST['search'])){
    $semester=$_POST['semester'];
    $subject=$_POST['subject'];
    $query="select * from ece_branch where semester='$semester' && subject='$subject'";          ///////////////////////////////////////////////////////
    $query2="select first_name,last_name from student,me_branch where me_branch.email=student.email";   ////////////////////////////
    $result=mysqli_query($conn,$query);
    $result2=mysqli_query($conn,$query2);
    $path='localhost/cusatified/upload_ece/';    ///////////////////////////////////////////////////
} ?>
...
<nav>
    <div class="nav-wrapper">
      <div class="col s12">
        <a href="ece_branch.php" class="breadcrumb">Electronics and Communication</a>       <!--------------------------------------------------  -->     
      </div>
    </div>
</nav>

</div></div>
<form action="ece_branch.php" method="POST">     <!--------------------------------------------------  -->   
<div class="row">
...
Want to upload Notes ?? <a href="upload_ece.php">Click here to upload</a> <!--------------------------------------------------  -->   
...
if(mysqli_num_rows($result)>0){
    ...
    <tr>
                    ...
                    <td><a href="download_ece.php?notes_id=<?php echo $row['notes_id']; ?>"><button type="button">Download</button></a></td><!-------------------------------------------------- -->
