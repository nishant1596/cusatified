...
if(isset($_POST['submit'])){
    ...
    $destination="./uploads/upload_civil/".$filename; /////////////////////////////////////////////////////
    ...
    $time=date('d/m/y');
    $query="insert into civil_branch (email,file,caption,time,semester,subject,path) values ('$user','$filename','$caption','$time','$semester','$subject','$destination')";
   /////////////////////////////////////////////////////////////////////////////
    
    $result=mysqli_query($conn,$query); 
    if($result){
        move_uploaded_file($tmploc,$destination);
        echo "You have successfully inserted your file into database";
    }
    else{
...
<h5 style="margin-left: 10px;">You are now uploading notes in <b><ul>CIVIL branch</ul></b><br />Please select semester in which you want to upload<br />If you want to change your branch, please go <br />to select-branch section and click upload<br /> button in respective branch</h5>
...
<script type="text/javascript" src="civil_branch.js"></script><!----------------------------------------- -->
<?php
include 'footer.php';
?>