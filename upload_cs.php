...
if(isset($_POST['submit'])){
    ...
    $destination="./uploads/upload_cs/".$filename; /////////////////////////////////////////////////////
    ...
    $time=date('d/m/y');
    $query="insert into cs_branch (email,file,caption,time,semester,subject,path) values ('$user','$filename','$caption','$time','$semester','$subject','$destination')";
   /////////////////////////////////////////////////////////////////////////////
...
<h5 style="margin-left: 10px;">You are now uploading notes in <b><ul>CS branch</ul></b><br />Please select semester in which you want to upload<br />If you want to change your branch, please go <br />to select-branch section and click upload<br /> button in respective branch</h5>
