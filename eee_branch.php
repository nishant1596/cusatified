...
include 'navbar.php';
$upload_dir = 'upload_eee/';   /////////////////////////////////////////////////////////////////// 
?>
<?php 
if(isset($_POST['search'])){
    $semester=$_POST['semester'];
    $subject=$_POST['subject'];
    $query="select * from eee_branch where semester='$semester' && subject='$subject'";          ///////////////////////////////////////////////////////
    $query2="select first_name,last_name from student,me_branch where me_branch.email=student.email";   ////////////////////////////
    $result=mysqli_query($conn,$query);
    $result2=mysqli_query($conn,$query2);
    $path='localhost/cusatified/upload_eee/';    ///////////////////////////////////////////////////
} ?>
...
<nav>
    <div class="nav-wrapper">
      <div class="col s12">
        <a href="eee_branch.php" class="breadcrumb">Electrical Engineering Engineering</a>       <!--------------------------------------------------  -->     
      </div>
    </div>
</nav>

</div></div>
<form action="eee_branch.php" method="POST">     <!--------------------------------------------------  -->   
<div class="row">
...
Want to upload Notes ?? <a href="upload_eee.php">Click here to upload</a> <!--------------------------------------------------  -->   
...
if(mysqli_num_rows($result)>0){
    ...
    <tr>
                    ...
                    <td><a href="download_eee.php?notes_id=<?php echo $row['notes_id']; ?>"><button type="button">Download</button></a></td><!-------------------------------------------------- -->
