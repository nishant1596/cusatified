...
<a href="#" data-activates="slide-out" class="button-collapse"><i class="material-icons">menu</i></a>
    <div class="nav-wrapper z-depth-5 hoverable " style="background: linear-gradient(to right,#8a3ab9,#4c68d7,#cd486b,#fbad50,#bc2a8d,#e95950);" >
      ...
      <ul id="nav-mobile" class="right ">
        <li><a href="#" class="hoverable z-depth-5 dropdown-button" data-beloworigin="true" data-activates="login_dropdown" style="font-family: Oswald;">Log-In</a></li>
...
<ul id="slide-out" class="side-nav">
    <ul class="collapsible collapsible-accordion">
      ...
      <div class="collapsible-body">
      <ul>
        <li><a href="signup_faculty.php">Sign-Up as Student</a></li>
        <li><a href="signup_student.php">Sign-Up as Faculty</a></li>
      </ul>
      </div></li>
...
<nav>
    <div class="nav-wrapper">
      <div class="col s12">
        ...
        <a href="signup_faculty.php" class="breadcrumb">Student-SignIn</a>
...
<div class="col l6 s12 m12">
 <form class="col s12" method="POST" action="login_student_validate.php">
 <div class="row">
  ...
  <a href="signup_student.php" style="float: left; border-bottom: 1px dotted blue;">Not a Member yet<br />Sign-up here</a>
  <a href="forgot_password.php" style="float: right; border-bottom: 1px dotted black;">Forgot Password ?</a>
  </div>
  <div class="row"><div class="col s12 center">
     <button class="btn waves-effect hoverable z-depth-4" style="background: linear-gradient(to right,#8a3ab9,#4c68d7,#cd486b,#fbad50,#bc2a8d,#e95950); " type="submit" name="submit">Sign In
