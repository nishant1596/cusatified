...
<ul id="slide-out" class="side-nav">
  ...
  <!------------------------------------------------------Student Forms Starts from here---------------------------------------------------------------- -->
  <!------------------------------------------------------                      ---------------------------------------------------------------- -->
  <div class="row">
<div class="col l3 ">
<nav>
    <div class="nav-wrapper">
      <div class="col s12">
        <a href="index.html" class="breadcrumb">Cusatified</a>
        <a href="signup_student.php" class="breadcrumb">Student-Sign Up</a>
      </div>
    </div>
  </nav>
</div>
<div class="col s12 l6 m12">
    ...
    <form class="col s12" action="signup_student_validate.php" method="POST">
      <div class="row">
      <div class="input-field col s12 l12 m12">
      <input id="adm_no"  type="number" class="validate" required="" name="adm_no"/>
      ...
      <div class="row">
       <div class="input-field col s12">
          ...
          <input id="icon_telephone" type="number" maxlength="10" class="validate" required="" name="tel_no"/>
          <label for="icon_telephone">Telephone</label>
        </div>
        </div>
        <div class="row">
       <div class="input-field col s12" >
    <select name="branch" required aria-required="true">
    <option value="" selected="" disabled="">Please select your branch</option>
      <option value="it_branch">Information Technology</option>
      <option value="cs_branch">Computer Science</option>
      <option value="eee_branch">Electrical Engineering</option>
      <option value="ece_branch">Electronics and Communication</option>
      <option value="me_branch">Mechanical Engineering</option>
      <option value="civil_branch">Civil Engineering</option>
      <option value="safety_safety">Safety and Fire </option>
    </select>
    <label>Select Department</label>
     ...
     <button class="btn waves-effect hoverable z-depth-4" style="background: linear-gradient(to right,#8a3ab9,#4c68d7,#cd486b,#fbad50,#bc2a8d,#e95950); " type="submit" name="submit">Create Account
    <i class="material-icons right">send</i>
  </button></div></div>
  <p>This button would not work, if you do not select the branch</p>
    </form>
  </div></div>
